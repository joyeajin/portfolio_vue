...
import port03 from "../assets/img/port3.jpg";
import port04 from "../assets/img/port4.jpg";
import port05 from "../assets/img/port5.jpg";
import port06 from "../assets/img/port6.jpg";
import port07 from "../assets/img/port7.jpg";
import port08 from "../assets/img/port8.jpg";
import port09 from "../assets/img/port9.jpg";
...
export const portText = [
  {
    ...
    img: port01,
    code: "https://github.com/joyeajin/talk",
    view: "https://joyeajin.github.io/talk/",
    name: "카카오톡 포트폴리오",
  },
  {
    num: "02",
    ...
    img: port02,
    code: "https://github.com/joyeajin/carribean",
    view: "https://joyeajin.github.io/carribean/",
    name: "캐리비안베이 포트폴리오",
  },
  {
    num: "03",
    ...
    // desc: "이 사이트는 정말 인상적인 포트폴리오입니다. 특히 스무스한 효과와 가로 모드드 높은 퀄리티를 자랑합니다. 디테일과 꼼꼼함이 넘치는 포트폴리오는 개발자의 뛰어난 능력을 엿볼 수 있습니다. GSAP와 React.js를 이용하여 사이트를 표현한 것은 기술적인 능력과 창의성을 강조하는데, 부족함이 없으며, 세심한 코딩과 디테일한 작업으로 그의 개발 감각과 능력이 빛을 발휘한 것 같습니다. ",
    img: port03,
    code: "https://github.com/joyeajin/kitchen",
    view: "https://joyeajin.github.io/kitchen/",
    name: "키친인큐베이터 포트폴리오",
  },
  {
    num: "04",
    ...
    img: port04,
    code: "https://github.com/joyeajin/baemin",
    view: "https://joyeajin.github.io/baemin/",
    name: "배달의민족 포트폴리오",
  },
  {
    num: "05",
    title: "fullpage 플러그인 사용",
    ...
    img: port05,
    code: "https://github.com/joyeajin/fullpage",
    view: "https://joyeajin.github.io/fullpage/",
    name: "fullpage 포트폴리오",
  },
  {
    num: "06",
    ...
    img: port06,
    code: "https://github.com/joyeajin/react03",
    view: "https://joyeajin.github.io/react03/",
    name: "json 포트폴리오",
  },
  {
    num: "07",
    ...
    img: port07,
    code: "https://github.com/joyeajin/react06-main",
    view: "https://joyeajin.github.io/react06-main/",
    name: "더보기, toggle 포트폴리오",
  },
  {
    num: "08",
    title: "tictacto game",
    ...
    img: port08,
    code: "https://github.com/joyeajin/tictacto_game",
    view: "https://joyeajin.github.io/tictacto_game/",
    name: "tictacto game 포트폴리오",
  },
  {
    num: "09",
    title: "todo app",
    ...
    img: port09,
    code: "https://github.com/joyeajin/react09-main",
    view: "https://joyeajin.github.io/react09-main/",
    name: "todo app 포트폴리오",
  },
  {
    num: "10",
    ...
    img: port10,
    code: "https://github.com/joyeajin/instagram",
    view: "https://joyeajin.github.io/instagram/",
    name: "instagram 포트폴리오",
  },
  {
    num: "11",
    title: "Vue instagram",
    // desc: "현대적이고 세련된 디자인으로 가득한 포트폴리오 사이트입니다. 모던한 느낌과 세심한 디테일이 조화를 이루며, 사용자에게 신선하고 품격 있는 경험을 제공합니다. 사이트의 디자인은 깔끔하고 단정하면서도 특유의 감성과 풍부한 표현력이 느껴집니다. 간결한 레이아웃과 모던한 색상 선택은 주인공의 디자인 감각을 잘 보여주는 특징입니다.",
    img: port11,
    code: "https://github.com/joyeajin/vue_study_star",
    view: "https://joyeajin.github.io/vue_study_star/",
    name: "instagram 포트폴리오",
  },
];
...
export const contactText = [
  {
    link: "https://open.kakao.com/o/s7UhrLee",
    title: "KAKAO : yj100009",
  },
  {
    link: "mailto:dpwls3334@naver.com",
